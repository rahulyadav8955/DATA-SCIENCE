...
numclaims <- read.table("F:/Classes/Day Wise/Day Wise/Day 16 Advanced Regression/Data Sets/numclaims.txt", header = T)
...
#=============================================
canins <-  read.table("F:/Classes/Day Wise/Day Wise/Day 16 Advanced Regression/Data Sets/canautoins.txt", header = T)
...
ornstein <- read.table("F:/Classes/Day Wise/Day Wise/Day 16 Advanced Regression/Data Sets/ornsteindata.txt", header = T)
